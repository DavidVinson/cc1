...
1. Create a `<button>` element on the DOM, you may do this with JavaScript, or write it directly in the HTML code. Have the button text read "Generate".

2. Using JavaScript, add a `<div>` element to the DOM when you click the button. It should append a new div each time you click the button.
